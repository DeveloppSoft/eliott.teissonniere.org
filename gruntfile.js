    ...
    copy: {
      dist: {
        files: [
          ...
          {expand: true, cwd: '.',    src: ['_redirects'], dest: 'dist/theme'}
        ],
      },
      ...
      images: {
        files: [
          {expand: true, cwd: 'src/assets/img', src: ['**'], dest: 'dist/theme/assets/img'},
          {expand: true, cwd: 'src/assets/img/', src: ['**'], dest: 'dist/source/src/assets/img'}
        ],
      },
